...
configure_file(${CMAKE_CURRENT_LIST_DIR}/wxwidgets-targets.in.cmake ${CMAKE_CURRENT_BINARY_DIR}/${targetsFile}.cmake @ONLY)
install(FILES ${CMAKE_CURRENT_BINARY_DIR}/${targetsFile}.cmake DESTINATION ${CMAKE_INSTALL_CMAKEDIR})
if(XP_EXPOSE_WXTIFF)
  ExternalProject_Get_Property(${CMAKE_PROJECT_NAME} BINARY_DIR)
  set(tiffHdrs
