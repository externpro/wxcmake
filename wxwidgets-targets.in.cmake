...
if(UNIX)
  ...
  find_package(wxWidgets QUIET BYPASS_PROVIDER REQUIRED ${wx_all_libs})
  if(XP_WXDEBUG)
    if(DEFINED wxWidgets_VERSION AND wxWidgets_VERSION)
      set(_wxVer " (found version \"${wxWidgets_VERSION}\")")
    else()
      set(_wxVer " (wx-config version \"${wxVER}\")")
    endif()
    message(STATUS "Found wxWidgets: ${wxWidgets_LIBRARIES}${_wxVer}")
  ...
  elseif(wxbasename MATCHES wx_osx_cocoa)
    find_library(CARBON_LIBRARY Carbon)
    find_library(COCOA_LIBRARY Cocoa)
    find_library(IOKIT_LIBRARY IOKit)
    list(APPEND _wx_core_libs ${CARBON_LIBRARY} ${COCOA_LIBRARY} ${IOKIT_LIBRARY})
  endif()
  ...
  if(wxbasename MATCHES wx_gtk)
    find_package(OpenGL)
    if(TARGET OpenGL::GL)
      set(_wx_gl_libs OpenGL::GL)
    else()
      set(_wx_gl_libs GL)
    endif()
  elseif(wxbasename MATCHES wx_osx_cocoa)
    find_library(OPENGL_LIBRARY OpenGL)
    set(_wx_gl_libs ${OPENGL_LIBRARY})
  endif()
  set(_wx_html_deps core)
  set(_wx_media_deps core)
  if(wxbasename MATCHES wx_osx_cocoa)
    find_library(AudioToolbox_LIBRARY AudioToolbox)
    set(_wx_media_libs ${AudioToolbox_LIBRARY})
  endif()
  set(_wx_net_deps base)
  set(_wx_propgrid_deps adv)
  set(_wx_qa_deps core xml)
  set(_wx_ribbon_deps core)
  set(_wx_richtext_deps adv html xml)
  set(_wx_stc_deps core)
  set(_wx_stc_link wxscintilla)
  set(_wx_webview_deps core)
  set(_wx_wxpng_link wxzlib)
  set(_wx_wxtiff_link wxjpeg wxzlib)
  set(_wx_xml_deps base)
  set(_wx_xml_link wxexpat)
  set(_wx_xrc_deps adv html xml)
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
    ...
    list(APPEND _wx_base_libs Iconv::Iconv ${SYSTEM_LIBRARY})
